...
import cn.zhuatech.customerservice.domain.DomainCatalog;
import cn.zhuatech.customerservice.model.*;
import cn.zhuatech.customerservice.repository.*;
...
public class CustomerServiceService {
    ...
    public CustomerServiceService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
